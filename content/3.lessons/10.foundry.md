...
description: 'Learn how to use Foundry to test, deploy and interact with your smart contracts on Ethereum.'
image:
...
date: 2023-05-25
badge:
  label: foundry, Solidity
delivery: true
---

# Workshop - Foundry, a toolkit for Ethereum application development
...
Send us your project before may 26th 2023 23:59 UTC+2. The three best projects will be rewarded with 500$ in ETH each 💸.
